...
**Date:** 2026-08-08
**Status:** Retired by the THR-166 retirement. The former autonomous
TASK_FOLLOWUP continuation route and its policy/evidence envelope are rejected
at both thread and task ingress. The direct task route remains the human
manual-break-glass path; thread supersede, reply, decline, THR-181 and THR-225
retain their independent contracts. The remaining sections are historical
