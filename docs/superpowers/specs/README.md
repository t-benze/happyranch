...
| `2026-08-03-thr-055-proposal-review-server-contract.md` | current | THR-055 Skill Proposal Review server contract (Slice 1). Current source: `protocol/05c-orchestrator.md` §4.5. Implementation: `runtime/skills/lifecycle/`, `runtime/daemon/routes/skill_lifecycle.py`, `web/src/lib/api/skillLifecycle.ts`. |
