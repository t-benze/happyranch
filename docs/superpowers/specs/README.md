...
| `2026-08-03-thr-055-proposal-review-server-contract.md` | retired | Historical THR-055 Founder proposal-review contract, retired by seq 317 / TASK-4749. The B1 verified-agent create path remains separate and current. |
