...
| `2026-06-30-pr-ci-waiter-guarded-merge-design.md` | current | PR CI waiter and guarded merge engine design; contract in `protocol/00-completion-contract.md` and `docs/agent-guides/`. Implementation code does not exist yet (PR #1 docs-only). |
