...
class TestUserAuthoredSkillMaterialization:
    ...
    def test_lifecycle_skill_materialized_from_artifact(self, tmp_dir, test_settings, db):
        ...
        for sid in ("start-task", "jobs", "make-worktree", "thread", "dream", "todos"): (fix: add todos to task-context fixtures, correct SKILL.md self-target claim, and add docs parity for todos SystemContract)
