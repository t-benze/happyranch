...
def _make_cross_thread_store(db_path: str | None) -> MetricsStore:
    ...
    guarded by a ``threading.RLock`` (TASK-5443 maintenance slice), so the
    plain constructor is already cross-thread safe — the manual construction
    this helper used to perform is no longer needed.
    """
