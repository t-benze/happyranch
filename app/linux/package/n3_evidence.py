...
VERSION = 1
PHASES = {
    "startup": ("process_absent", "tsnet_admission_absent", "connector_staged_credential_service_owned_read_only", "sidecar_staged_credential_service_owned_read_only", "credential_source_retired", "credential_dropin_retired", "composite_ready_after_sidecar"),
