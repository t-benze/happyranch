...
VERSION = 1
PHASES = {
    "startup": ("process_absent", "tsnet_admission_absent", "connector_staged_credential_root_owned_0400", "sidecar_staged_credential_root_owned_0400", "credential_source_retired", "credential_dropin_retired", "composite_ready_after_sidecar"),
