...
from runtime.infrastructure.talk_store import TalkStore
from runtime.models import TalkRecord, TalkStatus, TaskRecord
...
async def end_talk(slug: str, talk_id: str, body: EndTalkBody, org: OrgDep) -> dict:
    async with org.db_lock:
        ...
        if learnings_dir.exists():
            ...
            from runtime.infrastructure.learnings_store import LearningsStore, LearningEntry
