...
def _run_command(
    ...
    def _launch() -> ExecutorResult:
        ...
        # Launch executor subprocess via platform isolation.
        # Raises PlatformIsolationError on unsupported platform
        # or subprocess failure — fail-closed before any subprocess.
