...
class AuditLogger:
    ...
    # --- Agent Schedules (Todos) ---
    #
    # THR-105.  Like work_hours, ``audit_log.task_id`` stores
    # ``SCHEDULE-NNN`` — the established generic-scope-id convention.
    # No column is altered or re-meant.
    ...
    def log_schedule_paused(self, schedule_id: str, agent: str) -> None:
        self._db.insert_audit_log(
            task_id=schedule_id,
            agent=agent,
    ...
    def log_schedule_cancelled(self, schedule_id: str, agent: str) -> None:
        self._db.insert_audit_log(
            task_id=schedule_id,
            agent=agent,
    ...
    def log_schedule_edited(
        self, schedule_id: str, agent: str, *, fields: list[str],
    ) -> None:
        self._db.insert_audit_log(
            task_id=schedule_id,
            agent=agent,
    ...
    def log_schedule_expired(self, schedule_id: str, agent: str) -> None:
        self._db.insert_audit_log(
            task_id=schedule_id,
            agent=agent,
