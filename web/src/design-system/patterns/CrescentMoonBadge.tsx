...
interface CrescentMoonBadgeProps {
  className?: string;
  /** Accessible label; defaults to the English copy so existing callers are unchanged. */
  label?: string;
}

export function CrescentMoonBadge({
  className,
  label = 'Dream-originated',
}: CrescentMoonBadgeProps): JSX.Element {
  return (
    <svg
