        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="min-w-0">
            <div className="mb-2 flex flex-wrap items-center gap-2">
              ...
              <SkillStatusBadge state={hidden ? 'no_eligibility_policy' : skill.validation_state} />
              {skill.retired_at && <span className="text-mono-sm text-fg-muted">Retired</span>}
            </div>
          ...
          <span className="text-mono-sm text-fg-subtle">v{skill.current_version_id}</span>
        </div>
      </article>
    </Link>
  );
