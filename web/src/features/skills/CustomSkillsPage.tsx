...
import { customSkillId } from '@/lib/api/customSkills';
import { EmptyState } from '@/design-system/patterns/EmptyState';
import { Button } from '@/design-system/primitives/Button';
import { useCustomSkillsCatalog } from '@/hooks/custom-skills';
...
export function CustomSkillsPage(): JSX.Element {
  ...
  if (query.error instanceof ApiError && query.error.status === 403) return <CustomSkillsState icon={<Shield size={28} />} title="Founder access required" body="Custom skill management is restricted to the founder. Agent sessions cannot view or change custom skills." />;
