...
# Abort all pending reply invocations for an open thread (founder abort of queued/working responders)
...
- **Confirm with user first:**
  ...
  - `threads abort-replies` — founder aborts all pending reply invocations for an open thread, clearing queued/working responders without transcript rows
